...
//   if ((*oddInd.rbegin() - *oddInd.begin() + 1) & 1) {
//   	// make even
//   	lld sz = *oddInd.rbegin() - *oddInd.begin() + 1;
//   	lld start = *oddInd.begin();
//   	lld end = *oddInd.rbegin();
//   	println(start, end);
//   	for4(i, start, end+1, 1) {
//   		if (arr[i] & 1) {
//   			arr[i] += sz;
//   			cout << sz << " ";
//   		} else {
...
//   	} else {
//   		lld sz = oddInd[1] -
//   		println(start, oddInd[1]);
//   		for4(i, start, oddInd[1]+1, 1) {
//   			if (arr[i] & 1) {
//    			arr[i] += sz;
//    			cout << sz << " ";
//    		} else {
