...
void solveEachTest(int _TestCase) {
    // cout << "Case #" << _TestCase << ": ";
    lld n, m1, m2; cin >> n >> m1 >> m2;

    // create par3t_1 and ran4k_1 at the place.
    vector<lld> par3t_1(n, 0);
    vector<lld> ran4k_1(n, 0);
    makeSet(n, par3t_1, ran4k_1);
    ...
    // _____error_____(n, m1, m2);
    forn(i, m1) {
        lld a, b; cin >> a >> b;
        --a, --b;
        Union(a, b, par3t_1, ran4k_1);
    }
    ...
    forn(i, n) {
        for (lld j = i+1; j < n; j++) {
            if (find_repr(i, par3t, ran4k) != find_repr(j, par3t, ran4k) and 
                find_repr(i, par3t_1, ran4k_1) != find_repr(j, par3t_1, ran4k_1)) {
                Union(i, j, par3t, ran4k);
                Union(i, j, par3t_1, ran4k_1);
                ans.push_back({i, j});
            }
        }
    }
