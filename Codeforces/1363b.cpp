...
void solveEachTest(int _TestCase) {
    ...
    int pref1[n] = {0}, suff1[n] = {0}, pref2[n] = {0}, suff2[n] = {0};
    ...
    for4(i, n-1, -1, -1) {
    	...
    	suff1[i] = suff1[i+1] + (s[i] == '0');
    	suff2[i] = suff2[i+1] + (s[i] == '1');
    }

    // error(pref1[n-1], pref2[n-1], suff1[0], suff2[0]);
    int ans = min({pref1[n-1], pref2[n-1], suff1[0], suff2[0]});

    forn(i, n-1) {
    	ans = min({ans, pref1[i] + suff1[i+1], pref2[i]+suff2[i+1]});
    }
